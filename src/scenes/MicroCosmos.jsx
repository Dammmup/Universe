    ...
    return (
        <group ref={networkGroup} position={[0, 0, 0]}>
            ...
            >
                ...
                <Text position={[0, -2, 0]} fontSize={0.8} color="#ffffff" outlineColor="black" outlineWidth={0.05}>
            ...
            >
                ...
                <Text position={[0, -2.5, 0]} fontSize={0.8} color="#ffffff" outlineColor="black" outlineWidth={0.05}>
